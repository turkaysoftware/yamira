...
namespace Yamira{
    internal class TSModules{
        ...
        public class TS_SoftwareCopyrightDate{
            public static string ts_scd_preloader = string.Format("\u00a9 2024-{0}, {1}.", DateTime.Now.Year, Application.CompanyName);
        }
        ...
        // READ LANG PATHS
        // ======================================================================================================
        public static readonly string ts_lf = Path.Combine(StartupPath, "y_langs");     // Main Path
        ...
        public class TS_ThemeEngine{
            ...
            public static readonly Dictionary<string, Color> DarkTheme = new Dictionary<string, Color>{
                ...
                // HEADER MENU COLOR MODE
                { "HeaderBGColor2", Color.FromArgb(34, 38, 44) },
                ...
                // ACCENT COLOR
                { "AccentColor", Color.FromArgb(255, 77, 77) },
                { "AccentColorHover", Color.FromArgb(255, 88, 88) },
                // DATAGRID COLOR
                ...
                { "DataGridHeaderBGColor", Color.FromArgb(255, 77, 77) },
